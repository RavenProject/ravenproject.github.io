...
<div class="wrapper mt-16 pb-20">
  ...
  <p>A new electrum client is being worked on! For now, you will need the <a href="https://github.com/kralverde/electrum-raven/releases">Electrum-RVN</a> wallet to manage your Ravencoin with a ledger device. The previously linked fork is an updated version of the outdated repository by <a href="https://github.com/standard-error">standard-error</a> (depreciated). Choose the most recent version and download the appropriate file for your operating system. To build your own binaries, refer to the README of <a href="https://github.com/kralverde/electrum-raven">https://github.com/kralverde/electrum-raven</a>.</p> 
